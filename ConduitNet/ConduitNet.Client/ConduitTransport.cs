...
namespace ConduitNet.Client
{
    public class ConduitTransport
    {
        ...
        private class Connection
        {
            ...
            private readonly ConcurrentDictionary<string, TaskCompletionSource<ConduitMessage>> _pendingCalls = new();
            private readonly Channel<ConduitMessage> _outgoingChannel;
            ...
            {
                _url = url;
                _outgoingChannel = Channel.CreateUnbounded<ConduitMessage>(new UnboundedChannelOptions
                {
                    SingleReader = true,
                    SingleWriter = false
                });
            ...
            public async Task<ConduitMessage> SendAsync(ConduitMessage message)
            {
                ...
                var tcs = new TaskCompletionSource<ConduitMessage>(TaskCreationOptions.RunContinuationsAsynchronously);
